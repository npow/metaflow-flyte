# Generated by metaflow-prefect on 2026-03-08T01:07:25
# Metaflow flow: ConfigMutableFlow
# Do not edit this file — regenerate with: python /Users/npow/code/metaflow/test/ux/core/flows/config/mutable_flow.py prefect compile <output.py>
...
# ---------------------------------------------------------------------------
FLOW_FILE: str = '/Users/npow/code/metaflow/test/ux/core/flows/config/mutable_flow.py'
FLOW_NAME: str = 'ConfigMutableFlow'
DATASTORE_TYPE: str = 'local'
METADATA_TYPE: str = 'local'
CODE_PACKAGE_URL: str = '/tmp/mf-prefect-test/.metaflow/ConfigMutableFlow/data/3a/3a68196fa9627137627da1fa5ffa05bd424524dc'
CODE_PACKAGE_SHA: str = '3a68196fa9627137627da1fa5ffa05bd424524dc'
CODE_PACKAGE_METADATA: str = '{"version": 0, "archive_format": "tgz", "mfcontent_version": 1}'
TAGS: list[str] = ['802257ae', 'test_mutable_flow_config_value_prefect_deployer']
NAMESPACE: str | None = None
WITH_DECORATORS: list[str] = []
ORIGIN_RUN_ID: str | None = None
STEP_CMD_TEMPLATES: dict[str, tuple[str, ...]] = {'start': ('/Users/npow/anaconda3/envs/py310/bin/python3', '-u', '/Users/npow/code/metaflow/test/ux/core/flows/config/mutable_flow.py', '--quiet', '--metadata', 'local', '--environment', 'local', '--datastore', 'local', '--event-logger', 'nullSidecarLogger', '--monitor', 'nullSidecarMonitor', '--with', 'prefect_internal', 'step', 'start', '--run-id', '__MF_RUN_ID__', '--task-id', '__MF_TASK_ID__', '--input-paths', '__MF_INPUT_PATHS__', '--split-index', '__MF_SPLIT_INDEX__', '--retry-count', '__MF_RETRY_COUNT__', '--max-user-code-retries', '__MF_MAX_USER_CODE_RETRIES__', '--tag', '802257ae', '--tag', 'test_mutable_flow_config_value_prefect_deployer', '--namespace', ''), 'end': ('/Users/npow/anaconda3/envs/py310/bin/python3', '-u', '/Users/npow/code/metaflow/test/ux/core/flows/config/mutable_flow.py', '--quiet', '--metadata', 'local', '--environment', 'local', '--datastore', 'local', '--event-logger', 'nullSidecarLogger', '--monitor', 'nullSidecarMonitor', '--with', 'prefect_internal', 'step', 'end', '--run-id', '__MF_RUN_ID__', '--task-id', '__MF_TASK_ID__', '--input-paths', '__MF_INPUT_PATHS__', '--split-index', '__MF_SPLIT_INDEX__', '--retry-count', '__MF_RETRY_COUNT__', '--max-user-code-retries', '__MF_MAX_USER_CODE_RETRIES__', '--tag', '802257ae', '--tag', 'test_mutable_flow_config_value_prefect_deployer', '--namespace', '')}
FLOW_CONFIG_VALUE: str | None = '{"config": {"parameters": [{"name": "param3", "default": "43"}, {"name": "param4", "default": "44"}], "step_add_environment": {"vars": {"STEP_LEVEL": "5"}}, "step_add_environment_2": {"vars": {"STEP_LEVEL_2": "6"}}, "flow_add_environment": {"vars": {"FLOW_LEVEL": "7"}}, "project_name": "config_project_2"}}'
...
def _step_start(run_id: str, parameters: dict[str, Any]) -> str:
    ...
    try:
        ...
        pass
    _extra_env.update({'FLOW_LEVEL': '7', 'STEP_LEVEL': '5', 'STEP_LEVEL_2': '6'})
...
def _step_end(run_id: str, prev_task_id: str) -> str:
    ...
    try:
        ...
        pass
    _extra_env.update({'FLOW_LEVEL': '7'})
...
@flow(name='config_project_2.ConfigMutableFlow', description='ConfigMutableFlow', task_runner=ThreadPoolTaskRunner(max_workers=10))
def config_mutable_flow(param3: str = '43', param4: str = '44', trigger_param: str = '') -> None:
    ctx = get_run_context()
    run_id: str = f"prefect-{ctx.flow_run.id}"
    parameters: dict[str, Any] = {'param3': param3, 'param4': param4, 'trigger_param': trigger_param}

    _tid_start: str = _step_start(run_id, parameters)
    _tid_end: str = _step_end(run_id, _tid_start)
