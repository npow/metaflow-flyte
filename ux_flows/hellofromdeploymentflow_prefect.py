# Generated by metaflow-prefect on 2026-03-08T01:05:37
# Metaflow flow: HelloFromDeploymentFlow
# Do not edit this file — regenerate with: python /Users/npow/code/metaflow/test/ux/core/flows/basic/hello_from_deployment.py prefect compile <output.py>
...
# ---------------------------------------------------------------------------
FLOW_FILE: str = '/Users/npow/code/metaflow/test/ux/core/flows/basic/hello_from_deployment.py'
FLOW_NAME: str = 'HelloFromDeploymentFlow'
DATASTORE_TYPE: str = 'local'
METADATA_TYPE: str = 'local'
CODE_PACKAGE_URL: str = '/tmp/mf-prefect-test/.metaflow/HelloFromDeploymentFlow/data/25/2579c57c6eb28424ca08fd4e58e1d1b81bbdc538'
CODE_PACKAGE_SHA: str = '2579c57c6eb28424ca08fd4e58e1d1b81bbdc538'
CODE_PACKAGE_METADATA: str = '{"version": 0, "archive_format": "tgz", "mfcontent_version": 1}'
TAGS: list[str] = ['802257ae', 'test_from_deployment_deployer']
NAMESPACE: str | None = None
WITH_DECORATORS: list[str] = []
ORIGIN_RUN_ID: str | None = None
STEP_CMD_TEMPLATES: dict[str, tuple[str, ...]] = {'start': ('/Users/npow/anaconda3/envs/py310/bin/python3', '-u', '/Users/npow/code/metaflow/test/ux/core/flows/basic/hello_from_deployment.py', '--quiet', '--metadata', 'local', '--environment', 'local', '--datastore', 'local', '--event-logger', 'nullSidecarLogger', '--monitor', 'nullSidecarMonitor', '--with', 'prefect_internal', 'step', 'start', '--run-id', '__MF_RUN_ID__', '--task-id', '__MF_TASK_ID__', '--input-paths', '__MF_INPUT_PATHS__', '--split-index', '__MF_SPLIT_INDEX__', '--retry-count', '__MF_RETRY_COUNT__', '--max-user-code-retries', '__MF_MAX_USER_CODE_RETRIES__', '--tag', '802257ae', '--tag', 'test_from_deployment_deployer', '--namespace', ''), 'end': ('/Users/npow/anaconda3/envs/py310/bin/python3', '-u', '/Users/npow/code/metaflow/test/ux/core/flows/basic/hello_from_deployment.py', '--quiet', '--metadata', 'local', '--environment', 'local', '--datastore', 'local', '--event-logger', 'nullSidecarLogger', '--monitor', 'nullSidecarMonitor', '--with', 'prefect_internal', 'step', 'end', '--run-id', '__MF_RUN_ID__', '--task-id', '__MF_TASK_ID__', '--input-paths', '__MF_INPUT_PATHS__', '--split-index', '__MF_SPLIT_INDEX__', '--retry-count', '__MF_RETRY_COUNT__', '--max-user-code-retries', '__MF_MAX_USER_CODE_RETRIES__', '--tag', '802257ae', '--tag', 'test_from_deployment_deployer', '--namespace', '')}
...
@flow(name='hello_from_deployment.HelloFromDeploymentFlow', description='Flow for testing from_deployment() with various parameter types.', task_runner=ThreadPoolTaskRunner(max_workers=10))
def hello_from_deployment_flow(alpha: float = 0.01, config_json: str = '{"layers": [64, 32]}', model_type: str = 'cnn', num_epochs: int = 10, use_gpu: bool = False) -> None:
    ctx = get_run_context()
    run_id: str = f"prefect-{ctx.flow_run.id}"
    parameters: dict[str, Any] = {'alpha': alpha, 'config_json': config_json, 'model_type': model_type, 'num_epochs': num_epochs, 'use_gpu': use_gpu}

    _tid_start: str = _step_start(run_id, parameters)
    _tid_end: str = _step_end(run_id, _tid_start)

if __name__ == '__main__':
    hello_from_deployment_flow()