# Generated by metaflow-prefect on 2026-03-08T01:05:27
# Metaflow flow: HelloProjectFlow
# Do not edit this file — regenerate with: python /Users/npow/code/metaflow/test/ux/core/flows/basic/helloproject.py prefect compile <output.py>
...
# ---------------------------------------------------------------------------
FLOW_FILE: str = '/Users/npow/code/metaflow/test/ux/core/flows/basic/helloproject.py'
FLOW_NAME: str = 'HelloProjectFlow'
DATASTORE_TYPE: str = 'local'
METADATA_TYPE: str = 'local'
CODE_PACKAGE_URL: str = '/tmp/mf-prefect-test/.metaflow/HelloProjectFlow/data/a5/a592cf1337703d55092388dcd3184dc64eed214c'
CODE_PACKAGE_SHA: str = 'a592cf1337703d55092388dcd3184dc64eed214c'
CODE_PACKAGE_METADATA: str = '{"version": 0, "archive_format": "tgz", "mfcontent_version": 1}'
TAGS: list[str] = ['b6c87b57', 'test_hello_project_deployer']
NAMESPACE: str | None = None
WITH_DECORATORS: list[str] = []
ORIGIN_RUN_ID: str | None = None
STEP_CMD_TEMPLATES: dict[str, tuple[str, ...]] = {'start': ('/Users/npow/anaconda3/envs/py310/bin/python3', '-u', '/Users/npow/code/metaflow/test/ux/core/flows/basic/helloproject.py', '--quiet', '--metadata', 'local', '--environment', 'local', '--datastore', 'local', '--event-logger', 'nullSidecarLogger', '--monitor', 'nullSidecarMonitor', '--with', 'prefect_internal', '--branch', 'b6c87b57', 'step', 'start', '--run-id', '__MF_RUN_ID__', '--task-id', '__MF_TASK_ID__', '--input-paths', '__MF_INPUT_PATHS__', '--split-index', '__MF_SPLIT_INDEX__', '--retry-count', '__MF_RETRY_COUNT__', '--max-user-code-retries', '__MF_MAX_USER_CODE_RETRIES__', '--tag', 'b6c87b57', '--tag', 'test_hello_project_deployer', '--namespace', ''), 'end': ('/Users/npow/anaconda3/envs/py310/bin/python3', '-u', '/Users/npow/code/metaflow/test/ux/core/flows/basic/helloproject.py', '--quiet', '--metadata', 'local', '--environment', 'local', '--datastore', 'local', '--event-logger', 'nullSidecarLogger', '--monitor', 'nullSidecarMonitor', '--with', 'prefect_internal', '--branch', 'b6c87b57', 'step', 'end', '--run-id', '__MF_RUN_ID__', '--task-id', '__MF_TASK_ID__', '--input-paths', '__MF_INPUT_PATHS__', '--split-index', '__MF_SPLIT_INDEX__', '--retry-count', '__MF_RETRY_COUNT__', '--max-user-code-retries', '__MF_MAX_USER_CODE_RETRIES__', '--tag', 'b6c87b57', '--tag', 'test_hello_project_deployer', '--namespace', '')}
...
@flow(name='hello_project.HelloProjectFlow', description='HelloProjectFlow', task_runner=ThreadPoolTaskRunner(max_workers=10))
def hello_project_flow() -> None:
    ctx = get_run_context()
